...
test_db_storage.py'])
    ...
    def test_get_none(self):
        """Test get with non-existing object"""
        non_existing_state = models.storage.get(State, "non-existing-id")
    ...
    def test_count_no_cls(self):
        ...
        state.save()
        # Check if total count increased by 1
